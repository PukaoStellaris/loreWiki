...
When paired with [[nihil-the-void|Nihil]], Aethereal Magic acts as a stabilizing agent. [[Luna Phantasma]]'s light "washes out" the corruption of the Void, allowing for a sustainable, infinite energy loop known as the Dual Star system.`
  },
  {
    id: 'equinox-magic',
    name: 'Equinox Magic',
...
[[general-xi|General Xi]] uses Equinox Magic to guide those with unstable high-output magic, such as [[Luna Phantasma]]. By mastering the confluence of these forces, practitioners can create "Perfect Confluence" slashes that harmonize destructive energy.`
  },
  {
    id: 'destinys-fall',
    name: "Destiny's Fall",
    ...
    description: `Destiny's Fall is the ultimate manifestation of [[Sentinel Phantasma|Sentinel]]'s power in her Vera Forma. The weapon is a dagger crafted from deep violet crystal encased in obsidian shadow.
...
At the center of its crossguard sits a brilliant white star that pulses with a heartbeat. The blade drips with void energy and is used to execute "Absolute Negation," a technique that deletes the essence of a target, effectively removing them from existence.`
  },
  {
    ...
    description: `"Falling Up" is a katana that hums with a faint violet resonance. It was enchanted by [[Sentinel Phantasma|Sentinel]] as a gift for [[Astral Anemos]] to grant her attacks the "crunch" and weight needed to cut through heavy armor.
